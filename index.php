...
<body>
    ...
    <div class="content-wrap">
		...
		<div class="content">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							...
							Each project I take on is based upon creating a final product that is built on collaboration and purpose. I want to achieve the desired goals, but it's also important to me that the relationships created along the way are just as meaningful. At the end of the day I just want to make great things with and for great people. <br><br>Here are samples of projects that I have had the opportunity to create. Click the project to see additional details.
							</p>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							...
							<p class="content-detail">
							My abilities and interests in the multiple areas of web has been a constant evolution. Design and coding will always have my heart, but in order to offer the best deliverables I feel it's important to also be adept in areas outside traditional design and programming. 
							</p>
						</div>
								...
								<ul class="listing-item skills-icons-text">
									...
									<li>
										<div class="col-md-4 col-sm-4">
											...
											<p class="text-grey">
											Marketing to me is about three steps: 1. Defining the product. 2. Finding the market, competition, and niche. 3. Building a focused strategy that creates awareness and credibility while maximizing ROI. 
											</p>
										</div>
									</li>
									...
									<li>
										<div class="col-md-4 col-sm-4">
											...
											<p class="text-grey">
											When looking for answers to questions or issues, this is where I always start. I also use analytics to ensure a positive user experience and forecast user behavior.
											</p>
										</div>
									</li>
								</ul>
								...
								<ul class="listing-item skills-icons-text">
									<li>
										<div class="col-md-4 col-sm-4">
											...
											<p class="text-grey">
											I learned very early in my career how essential a solid SEO strategy is. I focus on page rankings through rich content, good coding, search consoles, and search engine algorithm changes.
											</p>
										</div>
									</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							...
							<p class="content-detail">
							I have worked with large scale companies as well as smaller local startups. These opportunities have encouraged me to wear many different hats and provided a considerable amount of insight into the different areas of web and design.
							</p>
						</div>
						<div class="col-md-9 content-right">
							<div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="owl-carousel">
                                ...
                                <div class="list-testimonial">
                                    <div class="content-testimonial">
                                        <h4 class="testi">
                                        " Jason has a rare ability to create and bring life to a web page. The artistry he provides, is unlike any other web designer I've been associated with in the past. He showed me how a website can jump out at you through the intricate detail he adds. I would recommend him to any company. "
                                        </h4>
                                        <p class="people">
            ...
            <!--RESUME-->
            <section class="grey-bg" id="resume">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title-small-center">
                                <span>Resume</span>
                            </h2>
                            <div class="row">
